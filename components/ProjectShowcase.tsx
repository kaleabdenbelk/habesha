...
export default function ProjectShowcase() {
  ...
  return (
    <section id="projects" className="relative w-full min-h-screen bg-black py-24 md:py-32 px-6 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#57ff8f]/5 rounded-full blur-[120px] pointer-events-none" />
          ...
          {projects.map((project) => (
            <motion.div
              ...
              className={`relative group rounded-3xl overflow-hidden cursor-pointer bg-[#001827] border border-white/5 transition-all duration-500
                ...
                ${hoveredId === project.id ? 'border-[#57ff8f]/30 shadow-[0_0_40px_rgba(0,229,255,0.1)]' : ''}
              `}
            >
              {/* Image with overlay */}
              ...
              <div className="relative z-10 p-8 h-full flex flex-col justify-end">
                ...
                <div className="mt-6 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                  <div className="inline-flex items-center text-white font-bold text-sm tracking-widest gap-2">
                    ...
                    <div className="w-8 h-[1px] bg-[#57ff8f]" />
                  </div>
                </div>
              </div>
