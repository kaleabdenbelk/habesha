      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
        ...
        <div className="flex flex-col justify-center">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00E5FF]/10 border border-[#00E5FF]/20 text-[#00E5FF] text-[10px] font-bold tracking-widest uppercase mb-6">
              <Terminal className="w-3 h-3" />
              {CONTACT_CONTENT.protocol}
            </div>
            <h2 className="font-outfit text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
              {CONTACT_CONTENT.titlePrefix} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-white">{CONTACT_CONTENT.titleGradient}</span>
            </h2>
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-3 px-5 py-3 rounded-xl border transition-all duration-300 group
                      ${isSelected 
                        ? "bg-[#00E5FF]/10 border-[#00E5FF] text-[#00E5FF] shadow-[0_0_20px_rgba(0,229,255,0.2)]" 
                  ...
                  >
                    ...
                    {isSelected && (
                      <motion.div 
                        layoutId="chip-glow"
                        className="absolute inset-0 rounded-xl bg-[#00E5FF]/5 blur-md"
                      />
                    )}
                  </button>
                );
        ...
        >
          ...
          <div className="relative p-8 md:p-10 rounded-3xl bg-[#001827]/80 border border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden group">
            ...
            <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#00E5FF]/40 rounded-tl-3xl" />
            <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-[#00E5FF]/40 rounded-tr-3xl" />
            <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-[#00E5FF]/40 rounded-bl-3xl" />
            <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-[#00E5FF]/40 rounded-br-3xl" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-white font-outfit focus:outline-none focus:border-[#00E5FF] focus:ring-1 focus:ring-[#00E5FF]/30 transition-all placeholder:text-gray-700"
                  />
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-white font-outfit focus:outline-none focus:border-[#00E5FF] focus:ring-1 focus:ring-[#00E5FF]/30 transition-all placeholder:text-gray-700 resize-none"
                />
              </div>

              <motion.button
                whileHover={{ scale: 1.02, backgroundColor: "#00E5FF", color: "#001827" }}
                whileTap={{ scale: 0.98 }}
              ...
              >
                ...
                {/* Button Glow FX */}
                {!isTransmitting && (
                  <div className="absolute inset-0 rounded-2xl bg-[#00E5FF]/0 group-hover:bg-[#00E5FF]/10 blur-xl transition-all duration-500" />
                )}
              </motion.button>
            </form>
            ...
            <motion.div
              ...
              className="absolute left-0 right-0 h-px bg-[#00E5FF]/10 z-0 pointer-events-none"
            />
          </div>
          
          {/* Signal Pulse Background */}
          <div className="absolute -top-12 -right-12 w-32 h-32 bg-[#00E5FF]/5 rounded-full blur-3xl animate-pulse" />
        </motion.div>
      </div>
    </section>
  );
